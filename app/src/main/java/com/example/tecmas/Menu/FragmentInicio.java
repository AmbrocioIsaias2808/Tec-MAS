...
public class FragmentInicio extends Fragment {
    ...
    public List<InfoObjects> fill_with_data() {
        ...
        data.add(new InfoObjects("Entrega de Reconocimientos y Constancias a Personal del Instituto Tecnológico de Matamoros", "El Departamento de Recursos Humanos convocó a personal Docente y de Apoyo a la Docencia para realizar la entrega de constancias, estímulos por antigüedad por 10, 15, 20 y 25 años de servicio", R.drawable.ic_launcher_background));
        ...
        data.add(new InfoObjects("Celebramos 47 años de ser Territorio Gorila", "Con un contingente conformado por más de  1,000 jóvenes Estudiantes, Fundadores, Docentes y Personal de Apoyo a la Educación encabezado por la Maestra Mara Grassiel Acosta González, Directora del I.T.Matamoros y la Maestra Genoveva Hi González Directora de la Escuela Secundaria Técnica No. 4 “Gral. Lázaro Cárdenas del Río”, ", R.drawable.ic_launcher_background));
        data.add(new InfoObjects("El TecNM campus Matamoros Entrega 119 Títulos Profesionales", " El viernes 27 de septiembre de 2019 se realizó Ceremonia de Entrega de Títulos a egresados de 11 programas educativos, que acudieron en punto de las 18:00 hrs. al Centro de Información “Q.B.P. Andrés Ortega Guzmán”;", R.drawable.ic_launcher_background));
